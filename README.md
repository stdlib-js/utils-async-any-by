...
```javascript
anyByAsync = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/utils-async-any-by@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/utils-async-any-by/tags). For example,

```javascript
anyByAsync = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/utils-async-any-by@v0.2.0-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var anyByAsync = require( 'path/to/vendor/umd/utils-async-any-by/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/utils-async-any-by@umd/browser.js"></script>
```
...
[test-image]: https://github.com/stdlib-js/utils-async-any-by/actions/workflows/test.yml/badge.svg?branch=v0.2.0
[test-url]: https://github.com/stdlib-js/utils-async-any-by/actions/workflows/test.yml?query=branch:v0.2.0
...
[dependencies-image]: https://img.shields.io/david/stdlib-js/utils-async-any-by.svg
[dependencies-url]: https://david-dm.org/stdlib-js/utils-async-any-by/main
...
[deno-url]: https://github.com/stdlib-js/utils-async-any-by/tree/deno
[deno-readme]: https://github.com/stdlib-js/utils-async-any-by/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/utils-async-any-by/tree/umd
[umd-readme]: https://github.com/stdlib-js/utils-async-any-by/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/utils-async-any-by/tree/esm
[esm-readme]: https://github.com/stdlib-js/utils-async-any-by/blob/esm/README.md
[branches-url]: https://github.com/stdlib-js/utils-async-any-by/blob/main/branches.md

[stdlib-license]: https://raw.githubusercontent.com/stdlib-js/utils-async-any-by/main/LICENSE
